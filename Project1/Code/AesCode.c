...
static uint8_t temporaryState[16];
...
int main(int argc, const char * argv[]) {
	...
	uint8_t in_message[16] ={ 0x6b, 0xc1, 0xbe, 0xe2, 0x2e, 0x40, 0x9f, 0x96, 0xe9, 0x3d, 0x7e, 0x11, 0x73, 0x93, 0x17, 0x2a };
	uint8_t round = 0;
	uint8_t temp[4];
	...
	for(int i = 0; i < 4; i++)
	{
		// Subbytes + Shiftrows + MixColumns + AddRowKey
